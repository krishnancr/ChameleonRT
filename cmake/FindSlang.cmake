...
# Check for SLANG_PATH or Slang_ROOT variable
if (DEFINED SLANG_PATH)
    set(Slang_ROOT ${SLANG_PATH})
endif()
...
if (DEFINED Slang_ROOT)
    ...
    find_path(Slang_INCLUDE_DIR      # Set variable Slang_INCLUDE_DIR
              ...
              NO_DEFAULT_PATH
              PATHS "${Slang_ROOT}/include" "${Slang_ROOT}"
    ...
    find_library(Slang_LIBRARY       # Set variable Slang_LIBRARY
                 ...
                 NO_DEFAULT_PATH
                 PATHS "${Slang_ROOT}/bin/${Slang_BUILD_CONFIG}" "${Slang_ROOT}/lib" "${Slang_ROOT}"
...
find_program(Slang_COMPILER       # Set variable Slang_COMPILER
             slangc               # Find the slangc compiler executable
             PATHS "${SLANG_PATH}/bin" "${Slang_ROOT}/bin"
             DOC "path to slangc compiler executable"
)
