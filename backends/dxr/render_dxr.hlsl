// Simplified version that renders a flat green color
#include "util.hlsl"
...
void RayGen() {
    ...
    // Simple ray generation for flat green color
    RayDesc ray;
    ray.Origin = cam_pos.xyz;
    
    // Use the camera ray direction calculation from the original shader
